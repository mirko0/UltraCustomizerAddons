...
public class DownloadFileAsync extends Element {
    public DownloadFileAsync(UltraCustomizer ultraCustomizer) {
        super(ultraCustomizer);
    }

    @Override
    public String getName() {
        return "Download File (Async)";
    }

    @Override
    public String getInternalName() {
        return "down-file-from-url-async";
    }
    ...
    public String[] getDescription() {
        return new String[]{
                "This allows you to download a file","from url to specific path.", "ASYNCHRONOUSLY!"
        };
    }
