...
public class GetRequestBearer extends Element {
    public GetRequestBearer(UltraCustomizer ultraCustomizer) {
        super(ultraCustomizer);
    }

    @Override
    public String getName() {
        return "HTTP Get (Bearer)";
    }

    @Override
    public String getInternalName() {
        return "http-get-request-bearer";
    }
    ...
    public String[] getDescription() {
        return new String[]{"Sends a http get request to specified url with bearer token."};
    }
