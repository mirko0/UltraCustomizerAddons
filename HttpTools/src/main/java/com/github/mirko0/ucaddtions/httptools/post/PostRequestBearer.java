...
public class PostRequestBearer extends Element {
    public PostRequestBearer(UltraCustomizer ultraCustomizer) {
        super(ultraCustomizer);
    }

    @Override
    public String getName() {
        return "HTTP Post (Bearer)";
    }

    @Override
    public String getInternalName() {
        return "http-post-request-bearer";
    }
    ...
    public void run(ElementInfo info, ScriptInstance instance) {
        ...
        final String bearer = (String) this.getArguments(info)[2].getValue(instance);
