...
public class BroadcastAnimatedBossbar extends Element {

    public BroadcastAnimatedBossbar(UltraCustomizer ultraCustomizer) {
        super(ultraCustomizer);
    }

    @Override
    public String getName() {
        return "Broadcast Animated BossBar Message";
    }

    @Override
    public String getInternalName() {
        return "broadcast-bossbar-message-animated";
    }
    ...
    public String[] getDescription() {
        return new String[]{
                "Send animated bossbar message to all players"
        };
    }
