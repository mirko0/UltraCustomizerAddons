...
public class ReadTextFromUrl extends Element {
    public ReadTextFromUrl(UltraCustomizer ultraCustomizer) {
    ...
    public String[] getDescription() {
        return new String[]{"This element will allow you to read", "txt file from url."};
    }
