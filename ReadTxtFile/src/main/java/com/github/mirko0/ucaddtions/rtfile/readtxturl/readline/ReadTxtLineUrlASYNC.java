...
public class ReadTxtLineUrlASYNC extends Element {

    public ReadTxtLineUrlASYNC(UltraCustomizer ultraCustomizer) {
        super(ultraCustomizer);
    }

    @Override
    public String getName() {
        return "Read txt line (URL) (Async)";
    }

    @Override
    public String getInternalName() {
        return "read-txt-from-url-line-async";
    }
    ...
    public String[] getDescription() {
        return new String[]{"This element will allow you to read", "txt line from file using url asynchronously."};
    }
